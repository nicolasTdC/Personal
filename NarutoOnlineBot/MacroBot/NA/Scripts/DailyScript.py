...
def sapinho():
    ...
    pyautogui.mouseUp()
    time.sleep(5)
    ans=GA.imgFind('LevelUpConfirm.png')
    if ans is not None:
        GA.mouseClick(ans)
        time.sleep(1)
        pyautogui.press('esc')
...
def ArenaLoop(nbr):
    for _ in range(nbr):
        ...
        ans = GA.mouseClick(GA.imgFind('ArenaRankBattle.png')) 
        
        GA.mouseClick(ans)
        
        ans = GA.imgFind('ArenaFimConfirm.png')
        ans2 = GA.imgFind('ConfirmFimDeFase.png')
        ...
        ans2 = GA.imgFind('ConfirmArena2.png')
        ans3 = GA.imgFind('ArenaFimConfirmRankUp.png')
        if ans1 is not None:
            GA.mouseClick(ans1)
        if ans2 is not None:
            GA.mouseClick(ans2)
...
def ExpTreasure(fase):
    ...
    for _ in range(4):   
        ...
        ans = GA.imgFind('VictoryConfirm.png')
        while ans is None:
            ans = GA.imgFind('VictoryConfirm.png')
            GA.Auto2x()
        GA.mouseClick(ans)
